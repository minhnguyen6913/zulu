...
{block name='script'}
    ...
    <script type="application/javascript">
        ...
        function _add_submit() {
            if (validate()) {
                $.ajax({
                    url: "{$pathRoot}introduction/ajax_add",
                    type: "POST",
                    data:  $('#form').serialize(),
                    dataType: "JSON",
                    success: function (data) {
                        ...
                        if (data == '0') {
                            ...
                            document.location.href='{$pathRoot}introduction';
                        }
                    }
                });
            }
                    ...
                    buttons: {
                        'Xác nhận': {
                            ...
                            action: function () {
                                $.ajax({
                                    type: "POST",
                                    url: "{$pathRoot}introduction/ajax_edit",
                                    data: $('#form').serialize(),
                                    dataType: "JSON",
                                    success: function (data) {
                                        if (data == '0') {
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <label class="col-sm-12">Chọn hình số 01 <button type="button" class="btn btn-primary waves-effect fa fa-image" id="btnEdit" onclick="_add_image('image1')"></button></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-sm-12">Chọn hình số 02 <button type="button" class="btn btn-primary waves-effect fa fa-image" id="btnEdit" onclick="_add_image('image2')"></button></label>
                                            <div class="white-box text-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-sm-12">Chọn hình nền <button type="button" class="btn btn-primary waves-effect fa fa-image" id="btnEdit" onclick="_add_image('background')"></button></label>
                                            <div class="white-box text-center">
