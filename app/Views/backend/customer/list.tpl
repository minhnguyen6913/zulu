    ...
    <script type="application/javascript">
        ...
        function _load() {
            table = $('#myTable').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "{$pathRoot}customer/ajax_list",
                    "type": "POST"
                },
                "columnDefs": [{
        ...
        function _add() {
            document.location.href='{$pathRoot}customer/add';
        }
                ...
                buttons: {
                    'Đồng ý': {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "{$pathRoot}customer/ajax_delete",
                                data: {
                                    id : id
                                },
                                datatype: "text",
                                success: function (data) {
                                    swal("Thành công", "Xóa danh dữ liệu thành công", "success");
                                    reload_table();
                                }
                            });
                        }
    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Danh đối tác</h4>
            </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="{$pathRoot}/customer">Danh đối tác</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title m-b-0">Danh sách đối tác</h3>
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="tablesaw table-striped table-hover table-bordered table color-table info-table" data-tablesaw-mode="columntoggle">
                            ...
                            <tr>
                                ...
                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">Tên đối tác</th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
