...
{block name='script'}
   ...
   <script src="/assets/ample/plugins/bower_components/bootstrap-select/bootstrap-select.min.js" type="text/javascript"></script>
    ...
    <script type="application/javascript">
        ...
        function _add() {
            document.location.href='{$pathRoot}slide/add';
        }
                ...
                buttons: {
                    'Đồng ý': {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "{$pathRoot}slide/ajax_delete",
                                data: {
                                    id : id
                                },
                                datatype: "text",
    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Quảng cáo</h4>
            </div>
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="tablesaw table-striped table-hover table-bordered table color-table info-table" data-tablesaw-mode="columntoggle">
                            ...
                            <tr>
                                ...
                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">Tên quảng cáo</th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
