    ...
    <script type="application/javascript">
        ...
        function _load() {
            table = $('#myTable').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "{$pathRoot}activity/ajax_list",
                    "type": "POST"
                },
                "columnDefs": [{
        ...
        function _add() {
            document.location.href='{$pathRoot}activity/add';
        }
                ...
                buttons: {
                    'Đồng ý': {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "{$pathRoot}activity/ajax_delete",
                                data: {
                                    id : id
                                },
                                datatype: "text",
    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Danh sách hoạt động</h4>
            </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="{$pathRoot}/activity">Danh sách hoạt động</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title m-b-0">Danh sách hoạt động</h3>
