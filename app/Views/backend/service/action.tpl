            ...
            if ($("#name").val().trim() == "") {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data == '0') {
                            swal("Cảnh báo","Tên dịch vụ đã tồn tại" , "warning");
                        } else {
                            swal("Thành công","Thêm dữ liệu thành công !!!" , "success");
                            document.location.href='{$pathRoot}service';
                        }
                    }
                });
            }
                    ...
                    buttons: {
                        'Xác nhận': {
                            ...
                            action: function () {
                                $.ajax({
                                    type: "POST",
                                    url: "{$pathRoot}service/ajax_edit",
                                    data: $('#form').serialize(),
                                    dataType: "JSON",
                                    success: function (data) {
                                        if (data == '0') {
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <label class="col-sm-12">Hình icon <button type="button" class="btn btn-primary waves-effect fa fa-image" id="btnEdit" onclick="_add_image('icon')"></button></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-sm-12">Hình banner <button type="button" class="btn btn-primary waves-effect fa fa-image" id="btnEdit" onclick="_add_image('image')"></button></label>
                                            <div class="white-box text-center">
