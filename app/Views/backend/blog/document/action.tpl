    ...
    <script type="application/javascript">
        ...
        function _add_submit() {
            ...
            if (validate() && (file_check == true))  {
                $.ajax({
                    url: "{$pathRoot}document/ajax_add",
                    type: "POST",
                    data: form_data,
                    contentType:false,
                    processData:false,
        ...
        function validate_file(file) {
            if (file != undefined) {
                ...
                const size = 4000000; //4mb
                //check file type

                if (file.size > size) {
                    swal("Cảnh báo","Trọng lượng file tối đa không quá 4 mb !!!" , "warning");
                    return false;
                }
                    ...
                    buttons: {
                        'Xác nhận': {
                            ...
                            action: function () {
                                $.ajax({
                                    type: "POST",
                                    url: "{$pathRoot}document/ajax_edit",
                                    data: form_data,
                                    contentType:false,
                                    processData:false,
                                    dataType: "JSON",
    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">VĂN BẢN PHÁP QUY</h4>
            </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="#">Văn bản pháp quy</a></li>
                    {if $edit}<li class="active">Sửa văn bản pháp quy</li> {/if}
                    {if $add}<li class="active">Thêm văn bản pháp</li> {/if}
                </ol>
            </div>
        </div>
