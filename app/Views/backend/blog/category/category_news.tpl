    ...
    <script type="application/javascript">
        ...
        function _load() {
            table = $('#myTable').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "{$pathRoot}news/ajax_list?category_id={$id}",
                    "type": "POST"
                },
                "columnDefs": [{
        ...
        function _add() {
            document.location.href='{$pathRoot}news/add?category_id={$id}';
        }

        function _edit(id) {
            document.location.href='{$pathRoot}news/edit?id='+id;
        }
        function _delete(id) {
            $.confirm({
                title: 'Xác nhận',
                content: 'Bạn có chắc chắn xóa tin này?',
                icon: 'fa fa-question',
                theme: 'modern',
                closeIcon: true,
    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="{$pathRoot}/category">Mục nội dung</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title m-b-0">Danh sách tin</h3>
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="tablesaw table-striped table-hover table-bordered table color-table info-table" data-tablesaw-mode="columntoggle">
                            ...
                            <tr>
                                ...
                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">Tiêu đề</th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
