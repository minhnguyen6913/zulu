                ...
                <form class="forms-sample" action="{{$linkaction}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mt-3">
                            ...
                            <input type="file" name="image" id="image" class="form-control" placeholder="Hình ảnh" value="{{$user->image??''}}">
                            @if (isset($user))
                            <img src="{{asset($user->image)}}" alt="{{$user->fullname??''}}" class="rounded-circle img-fluid img-100 align-top mr-15">
                            @endif
                        </div>
